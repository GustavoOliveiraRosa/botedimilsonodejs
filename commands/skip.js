...
module.exports.run = async (bot, message, args) => {
    ...
    if (!queue) return [message.delete(), utils.timed_msg('⚠ Não tem musica tocando, tu é surdo?', 5000)];
    ...
    if (!message.member.hasPermission('ADMINISTRATOR')) {
        ...
        message.channel.send(`🎵 ${message.author}, VocÊ votou pra passar a musica! **${votes.votes}/3** votes`);
